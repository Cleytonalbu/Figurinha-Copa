...
public class UserService {
    ...
    public UserService(FigurinhaRepository figurinhaRepository, AlbumRepository albumRepository, UserRepository userRepository, PhotoRepository photoRepository, BCryptPasswordEncoder bCryptPasswordEncoder){
